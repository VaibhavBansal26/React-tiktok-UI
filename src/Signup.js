        ...
        <div className="signup">
            <div className="login__content">
                <div className="login__heading">
                    <h3>You need a TikTok</h3>
                    <h3>account to continue</h3>
                </div>
                ...
                <div className="login__body">
                    ...
                    <Button className ="login__button" type="submit">SignUp with Google</Button>
                </div>
                 
            </div>
            <div className="login__footer">
                <Link to="/" style={{textDecoration:"none",color:'black'}}>Already a Member ? Login</Link>
            </div>
